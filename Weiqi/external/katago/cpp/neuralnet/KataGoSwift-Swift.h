...
SWIFT_EXTERN void $s11KataGoSwift19CoreMLComputeHandleC5apply12spatialInput06globalI004metaI004maskI06policy0M4Pass5value10scoreValue9ownership9batchSizeySpySfG_A8OSitF(float * _Nonnull spatialInput, float * _Nonnull globalInput, float * _Nonnull metaInput, float * _Nonnull maskInput, float * _Nonnull policy, float * _Nonnull policyPass, float * _Nonnull value, float * _Nonnull scoreValue, float * _Nonnull ownership, ptrdiff_t batchSize, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // apply(spatialInput:globalInput:metaInput:maskInput:policy:policyPass:value:scoreValue:ownership:batchSize:)
// Stub struct to be used to pass/return values to/from Swift functions.
...
SWIFT_EXTERN struct swift_interop_returnStub_KataGoSwift_uint64_t_0_8 $s11KataGoSwift19MPSGraphModelHandleC9modelDesc6nnXLen0I4YLen20optimizeIdentityMaskACSgAA07SWModelH0V_s5Int32VALSbtcfC(const void * _Nonnull modelDesc, int32_t nnXLen, int32_t nnYLen, bool optimizeIdentityMask, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init(modelDesc:nnXLen:nnYLen:optimizeIdentityMask:)
SWIFT_EXTERN void $s11KataGoSwift19MPSGraphModelHandleC5apply5input0H6Global0H4Meta6policy0K4Pass5value10scoreValue9ownership9batchSizeySpySfG_A7NSitF(float * _Nonnull inputPointer, float * _Nonnull inputGlobalPointer, float * _Nonnull inputMetaPointer, float * _Nonnull policy, float * _Nonnull policyPass, float * _Nonnull value, float * _Nonnull scoreValue, float * _Nonnull ownership, ptrdiff_t batchSize, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // apply(input:inputGlobal:inputMeta:policy:policyPass:value:scoreValue:ownership:batchSize:)
...
SWIFT_EXTERN bool $s11KataGoSwift19MetalComputeContextC7useFP16Sbvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
...
SWIFT_EXTERN struct swift_interop_returnStub_KataGoSwift_uint64_t_0_8 $s11KataGoSwift25createCoreMLComputeHandle15coremlModelPath15serverThreadIdx17requireExactNNLen16numInputChannels0qr6GlobalS00qr4MetaS00q6PolicyS00q5ValueS00q5ScorewS00q9OwnershipS07contextAA0efG0CSgSS_SiSbs5Int32VA6rA19MetalComputeContextCtF(struct swift_interop_passStub_KataGoSwift_uint64_t_0_8_void_ptr_8_16 coremlModelPath, ptrdiff_t serverThreadIdx, bool requireExactNNLen, int32_t numInputChannels, int32_t numInputGlobalChannels, int32_t numInputMetaChannels, int32_t numPolicyChannels, int32_t numValueChannels, int32_t numScoreValueChannels, int32_t numOwnershipChannels, void * _Nonnull context) SWIFT_NOEXCEPT SWIFT_CALL; // createCoreMLComputeHandle(coremlModelPath:serverThreadIdx:requireExactNNLen:numInputChannels:numInputGlobalChannels:numInputMetaChannels:numPolicyChannels:numValueChannels:numScoreValueChannels:numOwnershipChannels:context:)
SWIFT_EXTERN struct swift_interop_returnStub_KataGoSwift_uint64_t_0_8 $s11KataGoSwift24createMPSGraphOnlyHandle9modelDesc15serverThreadIdx17requireExactNNLen7contextAA0e5ModelG0CSgAA07SWModelI0V_SiSbAA19MetalComputeContextCtF(const void * _Nonnull modelDesc, ptrdiff_t serverThreadIdx, bool requireExactNNLen, void * _Nonnull context) SWIFT_NOEXCEPT SWIFT_CALL; // createMPSGraphOnlyHandle(modelDesc:serverThreadIdx:requireExactNNLen:context:)
SWIFT_EXTERN void * _Nonnull $s11KataGoSwift25createMetalComputeContext6nnXLen0H4YLen7useFP16AA0efG0Cs5Int32V_AISbtF(int32_t nnXLen, int32_t nnYLen, bool useFP16) SWIFT_NOEXCEPT SWIFT_CALL; // createMetalComputeContext(nnXLen:nnYLen:useFP16:)
// Stub struct to be used to pass/return values to/from Swift functions.
...
SWIFT_EXTERN void $s11KataGoSwift17createSWModelDesc7version4name16numInputChannels0ij6GlobalK00ij4MetaK00i5ValueK00i5ScorenK00i9OwnershipK00i6PolicyK05trunk10policyHead05valueT0AA0eF0Vs5Int32V_SSA7rA07SWTrunkF0CAA08SWPolicytF0VAA07SWValuetF0VtF(SWIFT_INDIRECT_RESULT void * _Nonnull, int32_t version, struct swift_interop_passStub_KataGoSwift_uint64_t_0_8_void_ptr_8_16 name, int32_t numInputChannels, int32_t numInputGlobalChannels, int32_t numInputMetaChannels, int32_t numValueChannels, int32_t numScoreValueChannels, int32_t numOwnershipChannels, int32_t numPolicyChannels, void * _Nonnull trunk, const void * _Nonnull policyHead, const void * _Nonnull valueHead) SWIFT_NOEXCEPT SWIFT_CALL; // createSWModelDesc(version:name:numInputChannels:numInputGlobalChannels:numInputMetaChannels:numValueChannels:numScoreValueChannels:numOwnershipChannels:numPolicyChannels:trunk:policyHead:valueHead:)
...
SWIFT_EXTERN bool $s11KataGoSwift18testBatchNormLayer10descriptor9batchSize6nnXLen0K4YLen12inputPointer04maskO006outputO0SbAA07SWBatchfG4DescV_s5Int32VA2MSPySfGANSpySfGtF(struct swift_interop_passStub_KataGoSwift_void_ptr_0_8_void_ptr_8_16_void_ptr_16_24 descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float const * _Nonnull maskPointer, float * _Nonnull outputPointer) SWIFT_NOEXCEPT SWIFT_CALL; // testBatchNormLayer(descriptor:batchSize:nnXLen:nnYLen:inputPointer:maskPointer:outputPointer:)
SWIFT_EXTERN bool $s11KataGoSwift13testConvLayer10descriptor9batchSize6nnXLen0J4YLen12inputPointer06outputN0SbAA06SWConvF4DescV_s5Int32VA2LSPySfGSpySfGtF(const void * _Nonnull descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float * _Nonnull outputPointer) SWIFT_NOEXCEPT SWIFT_CALL; // testConvLayer(descriptor:batchSize:nnXLen:nnYLen:inputPointer:outputPointer:)
SWIFT_EXTERN bool $s11KataGoSwift30testGlobalPoolingResidualBlock10descriptor9batchSize6nnXLen0L4YLen12inputPointer04maskP006outputP0SbAA08SWGlobalfgH4DescC_s5Int32VA2MSPySfGANSpySfGtF(void * _Nonnull descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float const * _Nonnull maskPointer, float * _Nonnull outputPointer) SWIFT_NOEXCEPT SWIFT_CALL; // testGlobalPoolingResidualBlock(descriptor:batchSize:nnXLen:nnYLen:inputPointer:maskPointer:outputPointer:)
SWIFT_EXTERN bool $s11KataGoSwift17testResidualBlock10descriptor9batchSize6nnXLen0J4YLen12inputPointer04maskN006outputN0SbAA010SWResidualF4DescC_s5Int32VA2MSPySfGANSpySfGtF(void * _Nonnull descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float const * _Nonnull maskPointer, float * _Nonnull outputPointer) SWIFT_NOEXCEPT SWIFT_CALL; // testResidualBlock(descriptor:batchSize:nnXLen:nnYLen:inputPointer:maskPointer:outputPointer:)
...
class SWIFT_SYMBOL("s:11KataGoSwift19CoreMLComputeHandleC") CoreMLComputeHandle;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<KataGoSwift::CoreMLComputeHandle> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_CoreMLComputeHandle;
// Type metadata accessor for CoreMLComputeHandle
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s11KataGoSwift19CoreMLComputeHandleCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:11KataGoSwift19CoreMLComputeHandleC") CoreMLComputeHandle : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
/// Run inference on a batch of inputs
  SWIFT_INLINE_THUNK void apply(float * _Nonnull spatialInput, float * _Nonnull globalInput, float * _Nonnull metaInput, float * _Nonnull maskInput, float * _Nonnull policy, float * _Nonnull policyPass, float * _Nonnull value, float * _Nonnull scoreValue, float * _Nonnull ownership, swift::Int batchSize) SWIFT_SYMBOL("s:11KataGoSwift19CoreMLComputeHandleC5apply12spatialInput06globalI004metaI004maskI06policy0M4Pass5value10scoreValue9ownership9batchSizeySpySfG_A8OSitF");
protected:
  SWIFT_INLINE_THUNK CoreMLComputeHandle(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_CoreMLComputeHandle;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s11KataGoSwift19CoreMLComputeHandleCD;
  static inline constexpr $s11KataGoSwift19CoreMLComputeHandleCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_CoreMLComputeHandle {
public:
static SWIFT_INLINE_THUNK CoreMLComputeHandle makeRetained(void * _Nonnull ptr) noexcept { return CoreMLComputeHandle(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<KataGoSwift::CoreMLComputeHandle> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return KataGoSwift::_impl::$s11KataGoSwift19CoreMLComputeHandleCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<KataGoSwift::CoreMLComputeHandle> { using type = KataGoSwift::_impl::_impl_CoreMLComputeHandle; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace KataGoSwift SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("KataGoSwift") {
class SWIFT_SYMBOL("s:11KataGoSwift19MPSGraphModelHandleC") MPSGraphModelHandle;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<KataGoSwift::MPSGraphModelHandle> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_MPSGraphModelHandle;
// Type metadata accessor for MPSGraphModelHandle
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s11KataGoSwift19MPSGraphModelHandleCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:11KataGoSwift19MPSGraphModelHandleC") MPSGraphModelHandle : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK swift::Optional<MPSGraphModelHandle> init(const SWModelDesc& modelDesc, int32_t nnXLen, int32_t nnYLen, bool optimizeIdentityMask) SWIFT_SYMBOL("s:11KataGoSwift19MPSGraphModelHandleC9modelDesc6nnXLen0I4YLen20optimizeIdentityMaskACSgAA07SWModelH0V_s5Int32VALSbtcfc");
/// Run inference on a batch using MPSGraph (GPU).
  SWIFT_INLINE_THUNK void apply(float * _Nonnull inputPointer, float * _Nonnull inputGlobalPointer, float * _Nonnull inputMetaPointer, float * _Nonnull policy, float * _Nonnull policyPass, float * _Nonnull value, float * _Nonnull scoreValue, float * _Nonnull ownership, swift::Int batchSize) SWIFT_SYMBOL("s:11KataGoSwift19MPSGraphModelHandleC5apply5input0H6Global0H4Meta6policy0K4Pass5value10scoreValue9ownership9batchSizeySpySfG_A7NSitF");
protected:
  SWIFT_INLINE_THUNK MPSGraphModelHandle(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_MPSGraphModelHandle;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s11KataGoSwift19MPSGraphModelHandleCD;
  static inline constexpr $s11KataGoSwift19MPSGraphModelHandleCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_MPSGraphModelHandle {
public:
static SWIFT_INLINE_THUNK MPSGraphModelHandle makeRetained(void * _Nonnull ptr) noexcept { return MPSGraphModelHandle(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<KataGoSwift::MPSGraphModelHandle> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return KataGoSwift::_impl::$s11KataGoSwift19MPSGraphModelHandleCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<KataGoSwift::MPSGraphModelHandle> { using type = KataGoSwift::_impl::_impl_MPSGraphModelHandle; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
public:
  ...
  SWIFT_INLINE_THUNK bool getUseFP16() SWIFT_SYMBOL("s:11KataGoSwift19MetalComputeContextC7useFP16Sbvp");
protected:
...
SWIFT_INLINE_THUNK swift::Optional<CoreMLComputeHandle> createCoreMLComputeHandle(const swift::String& coremlModelPath, swift::Int serverThreadIdx, bool requireExactNNLen, int32_t numInputChannels, int32_t numInputGlobalChannels, int32_t numInputMetaChannels, int32_t numPolicyChannels, int32_t numValueChannels, int32_t numScoreValueChannels, int32_t numOwnershipChannels, const MetalComputeContext& context) noexcept SWIFT_SYMBOL("s:11KataGoSwift25createCoreMLComputeHandle15coremlModelPath15serverThreadIdx17requireExactNNLen16numInputChannels0qr6GlobalS00qr4MetaS00q6PolicyS00q5ValueS00q5ScorewS00q9OwnershipS07contextAA0efG0CSgSS_SiSbs5Int32VA6rA19MetalComputeContextCtF") SWIFT_WARN_UNUSED_RESULT {
  return swift::_impl::_impl_Optional<CoreMLComputeHandle>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KataGoSwift::_impl::swift_interop_returnDirect_KataGoSwift_uint64_t_0_8(result, KataGoSwift::_impl::$s11KataGoSwift25createCoreMLComputeHandle15coremlModelPath15serverThreadIdx17requireExactNNLen16numInputChannels0qr6GlobalS00qr4MetaS00q6PolicyS00q5ValueS00q5ScorewS00q9OwnershipS07contextAA0efG0CSgSS_SiSbs5Int32VA6rA19MetalComputeContextCtF(KataGoSwift::_impl::swift_interop_passDirect_KataGoSwift_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(coremlModelPath)), serverThreadIdx, requireExactNNLen, numInputChannels, numInputGlobalChannels, numInputMetaChannels, numPolicyChannels, numValueChannels, numScoreValueChannels, numOwnershipChannels, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(context)));
  });
}

/// Create a GPU-only compute handle using MPSGraph
SWIFT_INLINE_THUNK swift::Optional<MPSGraphModelHandle> createMPSGraphOnlyHandle(const SWModelDesc& modelDesc, swift::Int serverThreadIdx, bool requireExactNNLen, const MetalComputeContext& context) noexcept SWIFT_SYMBOL("s:11KataGoSwift24createMPSGraphOnlyHandle9modelDesc15serverThreadIdx17requireExactNNLen7contextAA0e5ModelG0CSgAA07SWModelI0V_SiSbAA19MetalComputeContextCtF") SWIFT_WARN_UNUSED_RESULT {
  return swift::_impl::_impl_Optional<MPSGraphModelHandle>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KataGoSwift::_impl::swift_interop_returnDirect_KataGoSwift_uint64_t_0_8(result, KataGoSwift::_impl::$s11KataGoSwift24createMPSGraphOnlyHandle9modelDesc15serverThreadIdx17requireExactNNLen7contextAA0e5ModelG0CSgAA07SWModelI0V_SiSbAA19MetalComputeContextCtF(KataGoSwift::_impl::_impl_SWModelDesc::getOpaquePointer(modelDesc), serverThreadIdx, requireExactNNLen, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(context)));
  });
}

/// Create a Metal compute context
SWIFT_INLINE_THUNK MetalComputeContext createMetalComputeContext(int32_t nnXLen, int32_t nnYLen, bool useFP16) noexcept SWIFT_SYMBOL("s:11KataGoSwift25createMetalComputeContext6nnXLen0H4YLen7useFP16AA0efG0Cs5Int32V_AISbtF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::_impl_MetalComputeContext::makeRetained(KataGoSwift::_impl::$s11KataGoSwift25createMetalComputeContext6nnXLen0H4YLen7useFP16AA0efG0Cs5Int32V_AISbtF(nnXLen, nnYLen, useFP16));
}
...
SWIFT_INLINE_THUNK SWModelDesc createSWModelDesc(int32_t version, const swift::String& name, int32_t numInputChannels, int32_t numInputGlobalChannels, int32_t numInputMetaChannels, int32_t numValueChannels, int32_t numScoreValueChannels, int32_t numOwnershipChannels, int32_t numPolicyChannels, const SWTrunkDesc& trunk, const SWPolicyHeadDesc& policyHead, const SWValueHeadDesc& valueHead) noexcept SWIFT_SYMBOL("s:11KataGoSwift17createSWModelDesc7version4name16numInputChannels0ij6GlobalK00ij4MetaK00i5ValueK00i5ScorenK00i9OwnershipK00i6PolicyK05trunk10policyHead05valueT0AA0eF0Vs5Int32V_SSA7rA07SWTrunkF0CAA08SWPolicytF0VAA07SWValuetF0VtF") SWIFT_WARN_UNUSED_RESULT {
  return KataGoSwift::_impl::_impl_SWModelDesc::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KataGoSwift::_impl::$s11KataGoSwift17createSWModelDesc7version4name16numInputChannels0ij6GlobalK00ij4MetaK00i5ValueK00i5ScorenK00i9OwnershipK00i6PolicyK05trunk10policyHead05valueT0AA0eF0Vs5Int32V_SSA7rA07SWTrunkF0CAA08SWPolicytF0VAA07SWValuetF0VtF(result, version, KataGoSwift::_impl::swift_interop_passDirect_KataGoSwift_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(name)), numInputChannels, numInputGlobalChannels, numInputMetaChannels, numValueChannels, numScoreValueChannels, numOwnershipChannels, numPolicyChannels, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(trunk), KataGoSwift::_impl::_impl_SWPolicyHeadDesc::getOpaquePointer(policyHead), KataGoSwift::_impl::_impl_SWValueHeadDesc::getOpaquePointer(valueHead));
  });
}
...
SWIFT_INLINE_THUNK bool testBatchNormLayer(const SWBatchNormLayerDesc& descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float const * _Nonnull maskPointer, float * _Nonnull outputPointer) noexcept SWIFT_SYMBOL("s:11KataGoSwift18testBatchNormLayer10descriptor9batchSize6nnXLen0K4YLen12inputPointer04maskO006outputO0SbAA07SWBatchfG4DescV_s5Int32VA2MSPySfGANSpySfGtF") SWIFT_WARN_UNUSED_RESULT {
  return KataGoSwift::_impl::$s11KataGoSwift18testBatchNormLayer10descriptor9batchSize6nnXLen0K4YLen12inputPointer04maskO006outputO0SbAA07SWBatchfG4DescV_s5Int32VA2MSPySfGANSpySfGtF(KataGoSwift::_impl::swift_interop_passDirect_KataGoSwift_void_ptr_0_8_void_ptr_8_16_void_ptr_16_24(KataGoSwift::_impl::_impl_SWBatchNormLayerDesc::getOpaquePointer(descriptor)), batchSize, nnXLen, nnYLen, inputPointer, maskPointer, outputPointer);
}

/// Test the convolution layer
SWIFT_INLINE_THUNK bool testConvLayer(const SWConvLayerDesc& descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float * _Nonnull outputPointer) noexcept SWIFT_SYMBOL("s:11KataGoSwift13testConvLayer10descriptor9batchSize6nnXLen0J4YLen12inputPointer06outputN0SbAA06SWConvF4DescV_s5Int32VA2LSPySfGSpySfGtF") SWIFT_WARN_UNUSED_RESULT {
  return KataGoSwift::_impl::$s11KataGoSwift13testConvLayer10descriptor9batchSize6nnXLen0J4YLen12inputPointer06outputN0SbAA06SWConvF4DescV_s5Int32VA2LSPySfGSpySfGtF(KataGoSwift::_impl::_impl_SWConvLayerDesc::getOpaquePointer(descriptor), batchSize, nnXLen, nnYLen, inputPointer, outputPointer);
}

/// Test the global pooling residual block
SWIFT_INLINE_THUNK bool testGlobalPoolingResidualBlock(const SWGlobalPoolingResidualBlockDesc& descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float const * _Nonnull maskPointer, float * _Nonnull outputPointer) noexcept SWIFT_SYMBOL("s:11KataGoSwift30testGlobalPoolingResidualBlock10descriptor9batchSize6nnXLen0L4YLen12inputPointer04maskP006outputP0SbAA08SWGlobalfgH4DescC_s5Int32VA2MSPySfGANSpySfGtF") SWIFT_WARN_UNUSED_RESULT {
  return KataGoSwift::_impl::$s11KataGoSwift30testGlobalPoolingResidualBlock10descriptor9batchSize6nnXLen0L4YLen12inputPointer04maskP006outputP0SbAA08SWGlobalfgH4DescC_s5Int32VA2MSPySfGANSpySfGtF(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(descriptor), batchSize, nnXLen, nnYLen, inputPointer, maskPointer, outputPointer);
}

/// Test the residual block
SWIFT_INLINE_THUNK bool testResidualBlock(const SWResidualBlockDesc& descriptor, int32_t batchSize, int32_t nnXLen, int32_t nnYLen, float const * _Nonnull inputPointer, float const * _Nonnull maskPointer, float * _Nonnull outputPointer) noexcept SWIFT_SYMBOL("s:11KataGoSwift17testResidualBlock10descriptor9batchSize6nnXLen0J4YLen12inputPointer04maskN006outputN0SbAA010SWResidualF4DescC_s5Int32VA2MSPySfGANSpySfGtF") SWIFT_WARN_UNUSED_RESULT {
  return KataGoSwift::_impl::$s11KataGoSwift17testResidualBlock10descriptor9batchSize6nnXLen0J4YLen12inputPointer04maskN006outputN0SbAA010SWResidualF4DescC_s5Int32VA2MSPySfGANSpySfGtF(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(descriptor), batchSize, nnXLen, nnYLen, inputPointer, maskPointer, outputPointer);
}
...
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 120 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK void CoreMLComputeHandle::apply(float * _Nonnull spatialInput, float * _Nonnull globalInput, float * _Nonnull metaInput, float * _Nonnull maskInput, float * _Nonnull policy, float * _Nonnull policyPass, float * _Nonnull value, float * _Nonnull scoreValue, float * _Nonnull ownership, swift::Int batchSize) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(KataGoSwift::_impl::$s11KataGoSwift19CoreMLComputeHandleC5apply12spatialInput06globalI004metaI004maskI06policy0M4Pass5value10scoreValue9ownership9batchSizeySpySfG_A8OSitF) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 176 / sizeof(void *));
  (* fptrptr_->func)(spatialInput, globalInput, metaInput, maskInput, policy, policyPass, value, scoreValue, ownership, batchSize, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK swift::Optional<MPSGraphModelHandle> MPSGraphModelHandle::init(const SWModelDesc& modelDesc, int32_t nnXLen, int32_t nnYLen, bool optimizeIdentityMask) {
  alignas(alignof(SWModelDesc)) char copyBuffer_consumedParamCopy_modelDesc[sizeof(SWModelDesc)];
  auto &consumedParamCopy_modelDesc = *(new(copyBuffer_consumedParamCopy_modelDesc) SWModelDesc(modelDesc));
  swift::_impl::ConsumedValueStorageDestroyer<SWModelDesc> storageGuard_consumedParamCopy_modelDesc(consumedParamCopy_modelDesc);
  return swift::_impl::_impl_Optional<MPSGraphModelHandle>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KataGoSwift::_impl::swift_interop_returnDirect_KataGoSwift_uint64_t_0_8(result, KataGoSwift::_impl::$s11KataGoSwift19MPSGraphModelHandleC9modelDesc6nnXLen0I4YLen20optimizeIdentityMaskACSgAA07SWModelH0V_s5Int32VALSbtcfC(KataGoSwift::_impl::_impl_SWModelDesc::getOpaquePointer(consumedParamCopy_modelDesc), nnXLen, nnYLen, optimizeIdentityMask, swift::TypeMetadataTrait<MPSGraphModelHandle>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK void MPSGraphModelHandle::apply(float * _Nonnull inputPointer, float * _Nonnull inputGlobalPointer, float * _Nonnull inputMetaPointer, float * _Nonnull policy, float * _Nonnull policyPass, float * _Nonnull value, float * _Nonnull scoreValue, float * _Nonnull ownership, swift::Int batchSize) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(KataGoSwift::_impl::$s11KataGoSwift19MPSGraphModelHandleC5apply5input0H6Global0H4Meta6policy0K4Pass5value10scoreValue9ownership9batchSizeySpySfG_A7NSitF) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 248 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK bool MetalComputeContext::getUseFP16() {
  return KataGoSwift::_impl::$s11KataGoSwift19MetalComputeContextC7useFP16Sbvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
